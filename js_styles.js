...
function nyamvuStyleBack() {
    return {
        rows: {
            ...
            // 3: {style: {borderBottom: "solid 1px black"}},
            // 5: {style: {borderBottom: "solid 1px black"}},
            // 6: {style: {borderBottom: "solid 1px black"}},
            // 7: {style: {borderBottom: "solid 1px black"}},
            // 8: {style: {borderBottom: "solid 1px black"}},
            // 9: {style: {borderBottom: "solid 1px black"}},
            // 11: {style: {borderBottom: "solid 1px black"}},
            // 12: {style: {borderBottom: "solid 1px black"}},
            // 14: {style: {borderBottom: "solid 1px black"}},
            // 16: {style: {borderBottom: "solid 1px black"}},
            // 18: {style: {borderBottom: "solid 1px black"}},
            // 19: {style: {borderBottom: "solid 1px black"}},
            // 20: {style: {borderBottom: "solid 1px black"}},
            // 21: {style: {borderBottom: "solid 1px black"}},
            // 22: {style: {borderBottom: "solid 1px black"}},
            // 23: {style: {borderBottom: "solid 1px black"}},
            // 24: {style: {borderBottom: "solid 1px black"}},
            // 25: {style: {borderBottom: "solid 1px black"}},
