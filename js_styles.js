...
function nyamvuStyleBack() {
    return {
        rows: {
            ...
            32: {style: {border: "none" , borderTop: "solid 2px black",borderBottom: "solid 2px black", padding:"10px"}}
        },
        cols: {
        ...
        cells: {
            ...
            "1_32": {attributes: {colspan: "24"}, style:{textAlign: "center"}},
        }
    }
}
